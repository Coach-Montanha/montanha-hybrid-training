...
import { a as defineLazyEventHandler, n as HTTPError, p as NodeResponse, t as H3Core } from "./_libs/h3+rou3+srvx.mjs";
import "./_libs/hookable.mjs";
import "./_libs/ufo.mjs";
import "./_libs/ocache+ohash.mjs";
...
var _lazy_XXHB6f = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_XXHB6f
	};
	return ((_m, p) => {
		return {
			data,
