...
import { $ as Lock, C as Sparkles, F as Search, R as RefreshCw, Ut as CircleCheck, Vt as CircleX, et as LockOpen, h as Trash2, m as TriangleAlert, u as Users, z as Plus } from "../_libs/lucide-react.mjs";
import { n as generateTempAccessInvite, r as validateEmailMx } from "./ecosystem-auth-service-0n7cr2k9.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/master-admin-BEFZPTe6.js
...
var MasterAdminDashboard = () => {
	...
	const [newProjectId, setNewProjectId] = (0, import_react.useState)("sistema-hibrido");
	...
	const fetchSubscriptions = async () => {
		...
		let loaded = [];
		try {
			const url = typeof import.meta !== "undefined" && "https://lbipleflzhzfspyesclm.supabase.co" || typeof process !== "undefined" && process.env?.SUPABASE_URL;
			const key = typeof import.meta !== "undefined" && "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxiaXBsZWZsemh6ZnNweWVzY2xtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODQ0NDEzNzksImV4cCI6MjEwMDAxNzM3OX0.BCgmbYmU_FZR9B3LrScTOHk_UFn4BbWDK2wM36g9_eI" || typeof process !== "undefined" && (process.env?.SUPABASE_ANON_KEY || process.env?.SUPABASE_PUBLISHABLE_KEY);
			if (url && key) {
