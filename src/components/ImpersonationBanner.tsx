...
export const ImpersonationBanner: React.FC = () => {
  ...
  return (
    <aside aria-label="Aviso de Modo Suporte Técnico" className="sticky top-0 z-[9999] w-full bg-gradient-to-r from-amber-500/20 via-purple-500/20 to-cyan-500/20 border-b border-amber-500/40 backdrop-blur-xl px-4 py-2 text-xs text-amber-200 shadow-lg">
